...
| **S5** Provider auto-route (load balance finders) | [#69](https://github.com/vega113/skodun/issues/69) | [s5-provider-auto-route.md](s5-provider-auto-route.md) | **Shipped** — Phase A [PR #83](https://github.com/vega113/skodun/pull/83), telemetry [PR #85](https://github.com/vega113/skodun/pull/85), Phase B [PR #97](https://github.com/vega113/skodun/pull/97). Phase C closed as not warranted ([#109](https://github.com/vega113/skodun/issues/109)) |
