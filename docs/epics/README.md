...
| **S5** Provider auto-route (load balance finders) | [#69](https://github.com/vega113/skodun/issues/69) | [s5-provider-auto-route.md](s5-provider-auto-route.md) | **Design** — [spec](../superpowers/specs/2026-08-03-provider-auto-route-design.md) |
