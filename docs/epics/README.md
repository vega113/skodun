...
| **S4** Multi-slot FG + per-provider concurrency + 429 backoff | [#56](https://github.com/vega113/skodun/issues/56) | [s4-multi-slot-provider-concurrency.md](s4-multi-slot-provider-concurrency.md) | **Open** — design [S4 spec](../superpowers/specs/2026-08-02-s4-multi-slot-provider-concurrency-design.md) |
