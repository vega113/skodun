...
def test_parallel_benchmark_preserves_workload_calls_and_coverage(tmp_path):
    report = run_fixture(tmp_path / 'fixture', delay_seconds=.3)
    ...
    assert one['provider_peak'] == 1 and two['provider_peak'] == 2
